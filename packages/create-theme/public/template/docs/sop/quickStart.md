...
```sh [npm]
npm create 小小荧@latest my-first-blog
```

```sh [yarn]
yarn create 小小荧 my-first-blog
```

```sh [pnpm]
pnpm create 小小荧 my-first-blog
```
...
- [主题配置：首页&文章](https://www.xxytime.top/config/frontmatter.html) - 主题提供的一些 `frontmatter`
- [主题配置：全局](https://www.xxytime.top/config/global.html) - 主题提供的额外能力
- [主题配置：样式](https://www.xxytime.top/config/style.html) - 自定义博客样式介绍
- [主题配置：组件能力](https://www.xxytime.top/config/component.html) - 自定义博客样式介绍
